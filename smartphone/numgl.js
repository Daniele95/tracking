  ...
  store_webcam: function(videoElement) {
   ...
   //  window.stream = stream; // make variable available to browser console
    ...
    function errorMsg(msg, error) {
      const errorElement = document.querySelector('.log');
    ...
    /*
    videoElement = document.getElementById(videoElement);
    navigator.getMedia = (navigator.getUserMedia || navigator.mediaDevices.getUserMedia ||
    ...
    navigator.getMedia({
      ...
      function(err) {
        console.log("An error occured! ", err);
         ...
         console.log("control user media")
    var textureId = numgl.store_texture(videoElement);
    numgl.textureInfo[textureId].type = "webcam";
    return textureId;*/
